...
start chrome.exe http://localhost/Eclipse_Luna/Cake_FM_Viewer/nodes
start chrome.exe http://benfranklin.chips.jp/cake_apps/Cake_FM_Viewer/nodes
...
start firefox.exe http://localhost/Eclipse_Luna/Cake_FM_Viewer/nodes
start firefox.exe http://benfranklin.chips.jp/cake_apps/Cake_FM_Viewer/nodes
